...
class MainWindow(QMainWindow):
    ...
    def _about(self) -> None:
        QMessageBox.information(
            ...
            "Write is EARLY or LATE E92. Clone is not a full-chip copy: "
            "it writes cal, OS, HAS, and VIN. Boot, 0x1F000, 0x20000–0x3FFFF, "
            "and immobilizer/BCM stay on the spare.\n\n"
