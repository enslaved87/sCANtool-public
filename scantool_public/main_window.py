...
class MainWindow(QMainWindow):
    ...
    def _about(self) -> None:
        QMessageBox.information(
            ...
            "VIN/identity, configurable datalog, E92 full-read, and EARLY/LATE E92 flash write "
            ...
            "Write is EARLY or LATE E92. LATE clone writes the chip except "
            "4 KiB at 0x1F000 (left FF) and immobilizer/BCM. EARLY clone is "
            "still cal, OS, HAS, and VIN only.\n\n"
